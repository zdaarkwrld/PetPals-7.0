...
namespace PetPals_7._0.Controllers
{
    public class SchedulesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SchedulesId,time,date,ServiceName")] Schedules schedules)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SchedulesId,time,date,ServiceName")] Schedules schedules)
        {
        ...
        {
          return (_context.Schedules?.Any(e => e.SchedulesId == id)).GetValueOrDefault();
        }
    }
}
