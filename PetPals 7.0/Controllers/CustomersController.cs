...
namespace PetPals_7._0.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CustomersId,CustomersName,CustomersSurname")] Customers customers)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CustomersId,CustomersName,CustomersSurname")] Customers customers)
        {
