...
namespace PetPals_7._0.Controllers
{
    public class ServicesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ServicesId,ServiceNumber,ServiceIssueDate,CustomerID")] Services services)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ServicesId,ServiceNumber,ServiceIssueDate,CustomerID")] Services services)
        {
